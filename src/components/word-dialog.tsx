        ...
        <form ref={formRef} action={formAction} className="space-y-4 pt-2">
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              autoComplete="off"
              required
              className="h-11 rounded-xl border-2 focus-visible:ring-0 focus-visible:border-[#58cc02] text-base font-semibold"
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              required
              className="h-11 rounded-xl border-2 focus-visible:ring-0 focus-visible:border-[#58cc02]"
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              rows={3}
              className="w-full resize-none rounded-xl border-2 border-input bg-background px-3 py-2 text-sm placeholder:text-muted-foreground focus:outline-none focus:border-[#58cc02] transition-colors"
            />
          </div>
          ...
          <div className="flex gap-2 pt-1">
            ...
            <button
              type="submit"
              disabled={isPending}
              className="btn-duo flex-1 flex items-center justify-center gap-1.5 rounded-lg bg-[#58cc02] py-2.5 text-sm font-extrabold text-white shadow-[0_4px_0_#46a302] hover:bg-[#4db801] disabled:opacity-60 disabled:cursor-not-allowed transition-colors"
            >
