    ...
    return (
      <div className="flex w-full max-w-sm flex-col items-center gap-5 text-center">
        ...
        <div className="flex w-full gap-3">
          <Link
            href="/"
            className="btn-duo flex flex-1 items-center justify-center gap-1.5 rounded-xl border-2 py-3.5 text-sm font-extrabold hover:bg-muted transition-colors"
          >
          ...
          <button
            onClick={handleRetry}
            disabled={isRetrying}
            className="btn-duo flex flex-1 items-center justify-center gap-1.5 rounded-xl py-3.5 text-sm font-extrabold text-white disabled:opacity-70 disabled:cursor-not-allowed transition-colors"
